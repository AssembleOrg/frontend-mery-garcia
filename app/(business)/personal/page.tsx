...
import { Users, UserCheck, Receipt } from 'lucide-react';
...
import SeñasTab from '@/components/senas/SeñasTab';
    ...
    <ManagerOrAdminOnly>
      <MainLayout>
        <div className="min-h-screen bg-gradient-to-br from-[#f9bbc4]/15 via-[#e8b4c6]/12 to-[#d4a7ca]/10">
          <StandardPageBanner title="Gestión de Personal, Clientes y Señas" />
            ...
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
              ...
              <div className="mb-6 text-center">
                <h1 className="mb-2 text-2xl font-bold text-[#4a3540]">
                  Gestión de Personal, Clientes y Señas
                </h1>
                <p className="text-[#6b4c57]">
                  Administra tu equipo de trabajo, base de clientes y sistema de señas
                </p>
              </div>
              ...
              >
                ...
                <TabsContent value="señas" className="mt-0">
                  <SeñasTab />
                </TabsContent>
              </Tabs>
            </div>
