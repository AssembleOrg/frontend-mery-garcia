...
interface StandardPageBannerProps {
  title: string;
}

export default function StandardPageBanner({ title }: StandardPageBannerProps) {
  return (
    <div className="group relative h-48 w-full overflow-hidden md:h-56">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
        ...
        >
          <h1
            className="relative font-sans text-3xl font-bold text-[#f9bbc4] sm:text-4xl md:text-5xl"
            style={{
              textShadow: `
